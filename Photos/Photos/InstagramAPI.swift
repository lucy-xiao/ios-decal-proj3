        ...
        let task = NSURLSession.sharedSession().dataTaskWithURL(url) {
            ...
            if error == nil {
                ...
                do {
                    ...
                    var photoArrDict = feedDictionary.valueForKey("data") as! NSArray
//                    print(photoArrDict.objectAtIndex(1))
                    for dict in photoArrDict {
                        var photo = Photo.init(data: dict as! NSDictionary) as Photo
                        photos.append(photo)
                    }
